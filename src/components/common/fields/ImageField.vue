<template>
  <div class="image-input" :class="{ 'image-input--ready-to-drop': flags.isReadyToDrop }">
    ...
    <div class="image-input__input-inner">
      ...
      <input type="file" :disabled="disabled" @change="handleImageUpload" accept="image/*">
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      title: { type: String, default: 'Choose an image from your PC' },
      notes: {
        type: Array,
        default: () => [
          'JPEG, PNG or BMP',
          'no more than 5mb',
          'not less than 1024x1024, 1:1'
        ]
      },
